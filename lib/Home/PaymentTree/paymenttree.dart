      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          Row(
                            children: [
                              Text(Strings.referralTitle, style: const TextStyle(fontWeight: FontWeight.w700, fontSize: 16)),
                              const SizedBox(width: 4),
                              InkWell(
                                onTap: (){
                                  Widgets.infoDialog(Strings.referralTitle, Strings.referralContent);
                                },
                      ...
                      Row(
                        ...
                        children: [
                          Row(
                            children: [
                              Text(Strings.binaryTitle, style: TextStyle(fontWeight: FontWeight.w700, fontSize: 16),),
                              const SizedBox(width: 4),
                              InkWell(
                                onTap: (){
                                  Widgets.infoDialog(Strings.binaryTitle, Strings.binaryContent);
                                },
                                borderRadius: BorderRadius.circular(30),
                                child: const Icon(Icons.info_outline, color: Colors.grey, size: 16,)
                              )
                      ...
                      Row(
                        ...
                        children: [
                          Row(
                            children: [
                              Text(Strings.pendingTitle, style: const TextStyle(fontWeight: FontWeight.w700, fontSize: 16),),
                              const SizedBox(width: 4),
                              InkWell(
                                onTap: (){
                                  Widgets.infoDialog(Strings.pendingTitle, Strings.pendingContent);
                                },
                                borderRadius: BorderRadius.circular(30),
                                child: const Icon(Icons.info_outline, color: Colors.grey, size: 16,)
                              )
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              Obx(()=> Text(controller.homeController.totalWithdrawal.value, style: const TextStyle(fontWeight: FontWeight.w700, color: Colors.red, fontSize: 16),)),
                            ],
                          ),
                        ],
                      ),
                      ...
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          const Text("Available Amount", style: TextStyle(fontWeight: FontWeight.w700, fontSize: 16),),
                          Row(
                            children: [
                              const Icon(Icons.currency_rupee, color: Colors.green, size: 18,),
                              Obx(()=> Text(controller.homeController.availableAmount.value, style: TextStyle(fontWeight: FontWeight.w700, color: Colors.green, fontSize: 16))),
                            ],
                          ),
                        ],
                      ),
                  ...
                  Theme(
                    ...
                    child: Expanded(
                      child: SizedBox(
                        ...
                        child: TextButton(
                          onPressed: (){
                            controller.isWithDrawClicked.value?null:controller.payout();
                          },
                          style: TextButton.styleFrom(
                          ...
                          child: Obx(()=> controller.isWithDrawClicked.value?
                    ...
                    child: Row(
                      ...
                      children: [
                        Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            const Text("Withdraw instruction", style: TextStyle(fontWeight: FontWeight.w700, fontSize: 16),),
                            const SizedBox(height: 4),
                            Text("Tap to open", style: TextStyle(color: Colors.black.withOpacity(0.5), fontSize: 12),),
                          ],
                        ),
                        const Padding(
                          padding: EdgeInsets.all(8),
            ...
            Obx(()=> controller.homeController.referralCommission.value=="0.00" || controller.homeController.referralCommission.value == "0"?
            Column(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
